...
import type { ApiKeys as _ApiKeys, TtsResponse as _TtsResponse } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async generateTts(arg0: TtsRequest): Promise<TtsResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.generateTts(arg0);
                return from_candid_TtsResponse_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getApiKeys(): Promise<ApiKeys> {
        if (this.processError) {
            try {
                ...
                return from_candid_ApiKeys_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async saveApiKeys(arg0: string | null, arg1: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveApiKeys(to_candid_opt_n6(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n6(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveProject(arg0: string, arg1: string, arg2: string, arg3: Array<Segment>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveProject(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ApiKeys_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ApiKeys): ApiKeys {
    return from_candid_record_n5(_uploadFile, _downloadFile, value);
}
function from_candid_TtsResponse_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TtsResponse): TtsResponse {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        elevenLabsKey: record_opt_to_undefined(from_candid_opt_n3(_uploadFile, _downloadFile, value.elevenLabsKey)),
        preferredVoiceId: record_opt_to_undefined(from_candid_opt_n3(_uploadFile, _downloadFile, value.preferredVoiceId))
    };
}
